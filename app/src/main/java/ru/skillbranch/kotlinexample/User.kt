...
class User private constructor(
    ...
    meta: Map<String, Any>? = mapOf("auth" to "password")
    ...
    fun changePassword(oldPass: String, newPass: String) {
        ...
        } else throw  IllegalArgumentException("The entered password does match the current password")
    ...
    private fun encrypt(password: String): String {
        ...
        println("Salt while encryptЖ $salt")
